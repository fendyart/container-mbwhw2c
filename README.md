...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mbwhw2c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mbwhw2c.containers.anotherwebservice.com/
...
```
git clone git@github.com:fendyart/container-mbwhw2c.git
cd container-mbwhw2c
```
...
```
docker attach container-mbwhw2c
```
